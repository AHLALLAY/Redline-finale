      ...
      try {
        ...
        if (data.status === "success") {
          if (type === "charge") {
            ...
            setValue(`${data.data.charges.stats.average} ${data.data.currency}`);
            setBgColor('bg-red-100');
            setChange(`${data.data.charges.stats.count} charges ce mois`);
            ...
            setValue(`${data.data.produit.stats.average} ${data.data.currency}`);
            setBgColor('bg-green-100');
            setChange(`${data.data.produit.stats.count} produits ce mois`);
